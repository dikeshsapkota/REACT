function MainContent(){
  return (
    <main id="main-content" className="main-content">
      ...
      <ol>
        <li>React is one of the most popular frontend libraries in the world.</li>
        <li>Learning React will improve my chances of becoming a frontend developer.</li>
        <li>It helps build reusable and maintainable user interfaces.</li>
        <li>Many modern companies use React in production.</li>
        <li>React has a huge community and ecosystem.</li>
        <li>I can build real-world projects more efficiently.</li>
        <li>React works well with APIs and backend services.</li>
        <li>It is a valuable skill for internships and jobs.</li>
        <li>I can create responsive and interactive web applications.</li>
        <li>Learning React will help me become a better JavaScript developer.</li>
      </ol>

      <h2>My Learning Goals</h2>

      <p>
        My goal is to understand React fundamentals such as JSX, components,
